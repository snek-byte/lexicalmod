...
export function generateRandomPattern(mode: PatternMode = 'geopatterns') {
  ...
  return {
    thumbnail:
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="60"/>',
    full:
      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="1240" height="1748"/>'
  }
}
